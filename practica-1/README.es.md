...
Esto nos dice cuántos chips hay y sus líneas, pero **no los números globales**. Para saber el rango exacto de GPIOs de cada chip:
...
Aquí vemos la **base** (primer número) y el **tope** (último número) de cada chip.
...
> **¿Cómo sabemos que gpiochip1 tiene los GPIOs 480-495?**
>
> `gpiodetect` nos dice cuántas líneas tiene cada chip: `gpiochip1 [1-0021] (16 lines)`.
> Y `/sys/kernel/debug/gpio` nos da la **base**: `gpiochip1: GPIOs 480-495`.
>
> Con eso calculamos: **GPIO = base + número_de_línea**
>
> | GPIO | Chip | Base | Línea | Cálculo |
> |------|------|------|-------|---------|
...
### 2.3.4 Sobre el arranque automático

> 📌 **Para la práctica:** haced los pasos 2.3.1 a 2.3.3 y luego la confirmación (2.3.5) cada vez que empecéis. ¡Así aprendemos todo el proceso!
>
> 🔧 **Si queréis guardar la configuración permanentemente** para evitar repetirlo, ved el **Apéndice A** al final del documento.

### 2.3.5 Confirmación experimental

Una vez los GPIOs estén exportados y configurados, probad las salidas:
